...
### 🚀 v3.1 (2025-11-03) - Stepped Trailing Stop & Feature Updates

#### 💎 핵심 기능 추가
- **Stepped Trailing Stop 시스템**: 단계별 손절가 관리
  - 일반 트레일링 스탑과 달리 수익 단위별 보호 구간 제공
  - 백테스트 & 오토트레이딩 모두 적용
  - RISK 파라미터: 5% (1 unit)
  - 최소 손절: -3%

#### 📈 Stepped Trailing Stop 예시
```
수익률 범위    손절가      진입가 대비
0~4.99%      Entry×0.97   -3%
5~9.99%      Entry×1.00   0% (Breakeven)
10~14.99%    Entry×1.05   +5%
15~19.99%    Entry×1.10   +10%
```

#### 🔧 시스템 개선
- **Config 파일 통합**: strategy_signal_config.yaml로 단일화
- **Signal Timeline 강화**: 필터 조건 상세 정보 표시
- **마켓 시간 체크**: 주말/마켓 클로즈 시 WebSocket 자동 종료
- **백테스트 초기자본**: 100M (1억원) 설정

#### 📝 문서 업데이트
- Strategy Layer Interface: PositionManager 섹션 추가
- Service Layer Interface: BacktestConfig 업데이트
- CLAUDE.md: 핵심 기능 섹션 추가

---

### ✅ v2.0 (2025-10-09) - 새로운 아키텍처
